...
<div id="sectionContainerCenter">
	<div>
		<form id="frm" action="/restaurant/restRegProc" method="post" onsubmit="return chkFrm()">
			...
			<div>
				<input type="text" id="addr" name="addr" placeholder="주소" onkeyup="changeAddr()">
	...
	<script type="text/javascript"
		src="//dapi.kakao.com/v2/maps/sdk.js?appkey=3f868bb392c1e6e93d07ed5efbf99ec6&libraries=services"></script>
	<script>
		function chkFrm(){
