...
<div id="sectionContainerCenter">
	...
	<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=3f868bb392c1e6e93d07ed5efbf99ec6&libraries=services"></script>
...
//			var content = `<div class ="label"><span class="left"></span><span class="center">\${item.nm}</span><span class="right"></span></div>`;
		...
		if(navigator.geolocation){
			// return true:geolocation can be supported by os/browser, false: not supported
